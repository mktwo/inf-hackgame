...
namespace geHacktbal
{
	public partial class ProfileNameDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget geHacktbal.ProfileNameDialog
			this.Name = "geHacktbal.ProfileNameDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child geHacktbal.ProfileNameDialog.VBox
			...
			w2.Position = 0;
			w2.Fill = false;
			// Internal child geHacktbal.ProfileNameDialog.ActionArea
			...
			this.Show ();
			this.buttonCancel.Clicked += new global::System.EventHandler (this.OnButtonCancelPressed);
			this.buttonOk.Clicked += new global::System.EventHandler (this.OnButtonOkPressed);
		}
	}
}
